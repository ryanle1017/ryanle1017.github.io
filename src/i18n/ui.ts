export const ui = {
  ...
  'en': {
    ...
    subtitle: 'Welcome to Ryan\'s ',
    description: 'Thoughts. Afterthoughts. Reverberations. A personal journey through life and love, documented.',
    posts: 'Posts',
    tags: 'Tags',
    about: 'About',
  ...
  'zh': {
    title: '回响奥德赛',
    subtitle: 'Welcome to Ryan\'s',
    description: '这样的夏日，这样的山河，这样的灿烂，而又一寸一寸正在死去的夕阳。我们都因此沉默了好久。',
    posts: '文章',
    tags: '标签',
    about: '关于',
    toc: '目录',
  ...
  'zh-tw': {
    title: '迴響奧德賽',
    subtitle: 'Welcome to Ryan\'s',
    description: '我们不要在这里 跟我回去到十八岁 躲到台大校园的杜鹃花丛下 不要被命运找到',
    posts: '文章',
    tags: '標籤',
    about: '關於',
    toc: '目錄',
