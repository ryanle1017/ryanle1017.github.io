...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    author: 'Ryan',
    // site url
    url: 'https://ryanle1017.github.io',
    // base path
    // root directory for all pages and assets
    base: '/', // e.g., '/blog', '/docs'
    // favicon url
    // recommended formats: svg, png or ico
    favicon: '/icons/apple-globe-showing-asia-australia.png', // or https://example.com/favicon.svg
  },
  ...
  color: {
    ...
    light: {
      ...
      primary: 'oklch(25% 0.01 55)',
      // secondary color
      // used for post text
      secondary: 'oklch(35% 0.01 55)',
      // background color — very subtle warm white, barely tinted
      background: 'oklch(96% 0.01 85)',
      // highlight color — soft wheat
      // used for navbar, selected text, etc
      highlight: 'oklch(0.85 0.06 85 / 0.3)',
    },
    dark: {
      // primary color
      primary: 'oklch(92% 0.01 85)',
      // secondary color
      secondary: 'oklch(78% 0.01 85)',
      // background color — warm charcoal
      background: 'oklch(20% 0.01 55)',
      // highlight color
      highlight: 'oklch(0.50 0.06 85 / 0.25)',
    },
  },
  // COLOR SETTINGS >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> END
  ...
  comment: {
    ...
    // https://giscus.app/
    giscus: {
      repo: 'ryanle1017/ryanle1017.github.io',
      repoId: 'R_kgDON7hORQ',
      category: 'Announcements',
      categoryId: 'DIC_kwDON7hORc4C_FyR',
      mapping: 'pathname',
      strict: '0',
      reactionsEnabled: '1',
      emitMetadata: '0',
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/ryanle1017',
      },
      {
        name: 'Email',
        url: 'ryanlyr@outlook.com',
      },
      // {
      //   name: 'X',
